...
1) Avoir cicd-configuration avec les variables ci suivantes :   
...
2) Avoir rentré son projet dans le fichier `cicd-configuration/setup/build.yml` en respectant la documentation.  
